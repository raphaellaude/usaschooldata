...
export default function Home() {
  ...
  const {results, isSearching, error: searchError} = useSchoolSearch(searchQuery, isInitialized, 50);
    ...
    <div className="max-w-4xl mx-auto px-6 py-8">
      <div className="text-left mb-8">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          {dbLoading && searchQuery.length >= 3 && (
          ...
          {searchQuery.length >= 3 && results.length === 0 && !isSearching && !dbLoading && (
            <div className="mt-4 text-gray-500 p-4 bg-gray-50 rounded-lg">
