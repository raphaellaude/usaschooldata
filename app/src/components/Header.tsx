      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-12">
          ...
          <Link to="/" className="flex items-center space-x-2 hover:opacity-80 transition-opacity">
            <img src="/usaschooldata.svg" alt="USA School Data" className="h-6 w-6 brightness-0" />
            <span className="text-xl font-display text-gray-700">USA School Data</span>
          </Link>
          ...
          {showSearchBar && (
            <form onSubmit={handleSearch} className="hidden md:flex items-center space-x-2">
              <input
                ...
                className="px-3 py-1.5 w-56 text-sm bg-white text-gray-600 placeholder-gray-400 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <button
                type="submit"
